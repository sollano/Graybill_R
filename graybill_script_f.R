...
Tab_Res_Med <- data.frame(Resultado = rbind( mean(dados$Y1), mean(dados$Yj), var(dados$Y1), var(dados$Yj), sd(dados$Y1), sd(dados$Yj), length(dados$Y1), 2, fit$df.residual, Ftab, FH0, alpha, pvalor), 
