...
dados <- read.xlsx("D:/Documents/Trabalhos_Mensuracao/Scrips,Funcoes,Planilhas_automaticas/Graybill_R/dados_graybill.xlsx", sheetName = "graybill", header = TRUE)
...
FdeGraybill <- function(Y1, Yj, alpha = 0.05, Tab = 3) {
  ...
  colnames(Tab_Res_Simp) <- c("F(H0)","F Crit", "P-valor", "Alpha", "Teste")
  ...
  rownames(Tab_Res_Med) <- c("Media Y1", "Media Yj", "Variancia Y1", "Variancia Yj", "Desvio Padrao Y1", "Desvio Padrao Yj", "Observacoes", "g.l 1", "g.l 2", "Ftab", "F(H0)", "alpha",  "p valor")
  ...
  if(Tab==1){return(Tab_Res_Simp)} else if(Tab==2){return(Tab_Res_Med)}else(return(Tab_Res_Comp))
}
